/-!
# epitope-c-number Lean migration boundary
...
`epitope_c_number/SourcePackage.lean`.
...
def sourceRepository : String := "epitope-c-number"
def sourceUrl : String := "https://github.com/HautevilleHouse/epitope-c-number"
def sourceDescription : String := "Canonical-lane closure package for the Atiyah-Singer Index Theorem (proven): admissible-class formulation, projection gates, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["epitope-c-number", "canonical-lane", "admissible-class", "mathematical-proof", "reproducibility"]
