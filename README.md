# Atiyah-Singer Index Theorem (proven) — Canonical Lane Mathlib

Mathlib-backed Canonical Lane formalization package for the Atiyah-Singer Index Theorem (proven).

## Clean-clone replay

```bash
git clone https://github.com/HautevilleHouse/epitope-c-number-mathlib.git
cd epitope-c-number-mathlib
lake exe
lake build
```
